...
core::my_widget::my_widget() noexcept:
...
void core::my_widget::parse_it() const noexcept {
...
QString core::my_widget::parse_json_array(const QJsonArray& json) const noexcept {
  QString result;
